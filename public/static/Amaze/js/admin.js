    ...
    function AdminPanel(options)
    {
        ...
        $(document).keydown(function(event) {
            if(event.keyCode == 116) {
                ...
                $('.body-item.body-show iframe').attr('src', $('.body-item.body-show iframe').attr('src'));
                return false;
            } 
        });
    }
    AdminPanel.prototype =
    {
        ...
        switchTab(dataHref)
        {
            ...
            if (tabElem.length && bodyElem.length)
            {
                ...
                $('.app-widget-bodys div.body-item[data-href="' + dataHref + '"] iframe').attr('src', $('.app-widget-bodys div.body-item[data-href="' + dataHref + '"] iframe').attr('src'));
                this.rollTab("auto");
                this.options.callback(tabElem, bodyElem);
            }
        },
